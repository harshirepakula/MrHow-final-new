...
class FAQ_sViewController: UIViewController,UITableViewDataSource, UITableViewDelegate {
   ...
   var isFirstTimeClicked = false
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if let aSize = UIFont(name:fontStyle, size: 18) {
            ...
            self.navigationItem.title = languageChangeString(a_str: "FAQs")
            print("font changed")
...
func frequentlyAskedQuestions()
{
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        if language == "ar"{
           ...
           close.frame = CGRect(x:self.view.frame.width-40, y: 15, width: 20, height: 50)
        }
        else if language == "en"{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if language == "ar"{
             cell.contentTextLbl.textAlignment = .right
        ...
        if language == "ar"
        {
            ...
            GeneralFunctions.labelCustom_RTReg(labelName: cell.contentLbl, fontSize: 17)
            GeneralFunctions.labelCustom_RTReg(labelName: cell.contentTextLbl, fontSize: 15)
