...
- (void)layoutSubviews
{
    ...
    if (self.numberOfSegments >= 2)
    {
        ...
        if ([self isRangeSlidersPlacedAtExtremePosition])
        {
            ...
            [self.startSliderButton setImage:[UIImage imageNamed:@"Path 3472"] forState:UIControlStateNormal];
            ...
            [self.endSliderButton setImage:[UIImage imageNamed:@"Path 3472"] forState:UIControlStateNormal];
...
- (void)setDefaultValues
{
    ...
    self.rangeSliderBackgroundColor = [UIColor colorWithRed:13.0/255.0 green:205.0/255.0 blue:120.0/255.0 alpha:1.0];
    self.rangeSliderForegroundColor = [UIColor colorWithRed:13.0/255.0 green:205.0/255.0 blue:120.0/255.0 alpha:1.0];
    
    self.rangeDisplayLabelFont = [UIFont fontWithName:@"Poppins-Regular" size:12];
    self.rangeDisplayLabelColor = [UIColor whiteColor];
    
    self.segmentSelectedColor =  [UIColor colorWithRed:13.0/255.0 green:205.0/255.0 blue:120.0/255.0 alpha:1.0];;
    self.segmentUnSelectedColor = [UIColor colorWithRed:13.0/255.0 green:205.0/255.0 blue:120.0/255.0 alpha:1.0];
    ...
    self.minRangeImage.image = [UIImage imageNamed:@"Union 1"];
    ...
    self.maxRangeImage.image = [UIImage imageNamed:@"Union 1"];
...
self.minRangeLabel.text = [NSString stringWithFormat:@"%@ ",self.minRangeText ];
    
    
self.maxRangeLabel.text =  [NSString stringWithFormat:@"%@ ",self.maxRangeText ];
