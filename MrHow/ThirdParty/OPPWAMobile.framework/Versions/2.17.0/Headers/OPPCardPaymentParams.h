...
/**
 ...
 @return YES if the number consists of 12-19 digits and passes luhn test, NO if it doesn't.
 */
...
/**
 ...
 @deprecated Use +isNumberValid:luhnCheck: instead
 @see +isNumberValid:luhnCheck:
 */
...
/**
 ...
 @deprecated Use +isCvvValid: instead
 @see +isCvvValid:
 */
