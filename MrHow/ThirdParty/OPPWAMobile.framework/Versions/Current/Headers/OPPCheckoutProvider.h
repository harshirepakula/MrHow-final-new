...
/**
 ...
 @param checkoutProvider The instanse of OPPCheckoutProvider that is calling delegate method.
...
/**
 ...
 @param cancelHandler A block executed if the user closes the payment page prematurely.
 @deprecated Use -presentCheckoutForSubmittingTransactionCompletionHandler:cancelHandler: instead. Use delegate method [OPPCheckoutProviderDelegate checkoutProvider:continueSubmitting:comletion:] instead of implementing paymentBrandSelectedHandler.
 @see -presentCheckoutForSubmittingTransactionCompletionHandler:cancelHandler:
 */
- (void)presentCheckoutForSubmittingTransactionCompletionHandler:(void (^)(OPPTransaction * _Nullable transaction, NSError * _Nullable error))completionHandler
