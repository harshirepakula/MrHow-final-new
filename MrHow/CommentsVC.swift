...
//  MrHow
//
//  Created by harshitha on 17/09/19.
...
class CommentsVC: UIViewController,UITextViewDelegate {
    ...
    func replyComment(user_Id:String,topic_id:String,comment:String,lang:String){
        ...
        if (bool == false) {
            ...
            let parameters: Dictionary<String, Any> = ["api_key":APIKEY ,"lang":language,"user_id":user_Id,"comment_id":topic_id,"sub_comment":comment,"course_id":courseID]
          
            
            let url = "\(base_path)services/subcomments"
            //"https://www.volive.in/mrhow_dev/services/subcomments"
            print(url)
            print(parameters)
            ...
            Alamofire.request(url, method: .post, parameters: parameters, encoding: URLEncoding.default, headers: nil).responseJSON { response in
                ...
                if(status == 1)
                {
                    ...
                    NotificationCenter.default.post(name: NSNotification.Name("subcomment"), object: nil)
